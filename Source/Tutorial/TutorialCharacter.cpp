...
void ATutorialCharacter::InitEffects()
{
	for (TSubclassOf<UTutorialGameplayEffect> Effect : DefaultEffects)
	{
		AddEffect(Effect);
	}
}

void ATutorialCharacter::AddEffect(TSubclassOf<UTutorialGameplayEffect> Effect)
{
	if (!HasAuthority())
	{
	...
	{
		TSubclassOf<UTutorialGameplayEffect>& EffectRef = Effect;
...
bool ATutorialCharacter::ServerAddEffect_Validate(TSubclassOf<UTutorialGameplayEffect> Effect)
{
	return true;
}

void ATutorialCharacter::ServerAddEffect_Implementation(TSubclassOf<UTutorialGameplayEffect> Effect)
{
	AddEffect(Effect);
}
...
void ATutorialCharacter::GetLifetimeReplicatedProps(TArray<FLifetimeProperty> & OutLifetimeProps) const
{
	...
	DOREPLIFETIME(ATutorialCharacter, Effects);
}